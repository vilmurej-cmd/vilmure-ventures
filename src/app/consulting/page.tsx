...
const services = [
  ...
  },
  {
    title: 'Training',
    description:
      'Teach teams how to work with AI effectively — not as a tool to query, but as a partner to collaborate with. The same approach that built 36 platforms.',
    Icon: GraduationCap,
  },
];

const reasons = [
  'We didn\'t just read about AI-assisted development. We built 36 platforms with it.',
