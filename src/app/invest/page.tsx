...
const offerings = [
  ...
  },
  {
    ...
    description:
      '9 platforms spanning real estate, healthcare, music, language, discovery, medical science, safety, and children\'s health empowerment. 90,000+ lines of production code.',
    color: '#8B5CF6',
  },
  {
