...
const offerings = [
  ...
  },
  {
    ...
    description:
      '17 platforms spanning real estate, healthcare, music, language, discovery, medical science, safety, children\'s health empowerment, life management, and viral AI experiences. 90,000+ lines of production code.',
    color: '#8B5CF6',
  },
  {
