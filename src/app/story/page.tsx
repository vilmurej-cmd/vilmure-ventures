...
const timeline = [
  ...
  { date: 'Mar 2026', event: '13 new platforms in one weekend. 24 platforms. 90,000+ lines.', color: '#A78BFA' },
];
        ...
        <div className="max-w-6xl mx-auto">
          <ScrollReveal>
            ...
            <p className="mt-6 text-white/60 text-lg md:text-xl max-w-2xl mx-auto leading-[1.8]">
              How a real estate professional and an AI built 24 platforms in 7 months
            </p>
          </ScrollReveal>
        </div>
      </section>
